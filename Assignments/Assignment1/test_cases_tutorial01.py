...
actual_answers = [9, 12, 28, 7 , 4 , 5 , 6 ,8 , 81 , 9 , 0 ,[2,6,18,54],0,"error",0]
student_answers = []
...
test_case_14 = A1.printHP(1,1,4)
student_answers.append(test_case_14)

test_case_15 = A1.printHP(4,-1,6)
student_answers.append(test_case_15)
